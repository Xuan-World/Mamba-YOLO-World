...
Please refer to the [config for fine-tuning YOLO-World-L on COCO](../configs/YOLOWorld_finetune_coco/yolo_world_l_dual_vlpan_2e-4_80e_8gpus_finetune_coco.py) for more details.
...
You can refer to the [config for Efficient YOLO-World](../configs/YOLOWorld_finetune_coco/yolo_world_l_efficient_neck_2e-4_80e_8gpus_finetune_coco.py) for more details.
